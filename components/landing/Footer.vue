  ...
  <div class="text-sm mt-20">
      ...
      <div class="flex flex-col md:flex-row mb-8">
        <div class="md:w-2/4">
          ...
          <p class="text-slate-600 my-4 md:w-3/5">
            ...
            digital solutions to businesses and organisations.
          </p>
        ...
        <div class="md:w-1/4 flex flex-col justify-center mb-8 md:mb-0">
          <h4 class="text-amber-950 text-lg font-semibold">Explore</h4>
        ...
        <div class="md:w-1/4 flex flex-col justify-center">
          <h4 class="text-amber-950 text-lg font-semibold">Contact Us</h4>
    ...
    <div class="flex justify-center items-center text-white h-24">
      <p class="text-slate-700">
        © {{ new Date().getFullYear() }} Townsmeet Ltd. All rights reserved
      </p>
    </div>
  </div>
</template>
